...
public class Varasto {
    ...
    public Varasto(double tilavuus, double alkuSaldo) { // kuormitetaan
        ...
        this.saldo = maaritaAlkuSaldo(tilavuus, alkuSaldo);
    }
    
    public double maaritaAlkuSaldo(double tilavuus, double alkuSaldo) {
        if (alkuSaldo < 0.0) {
            return 0.0;
    ...
    //lisätään tänne jotain että voidaan pushata uudestaan
}